...
pub const VOLCANO: crate::Emoji = crate::Emoji {
    ...
    annotations: &[
        ...
        crate::Annotation {
            lang: "bg",
            tts: Some("вулкан"),
            keywords: &["вулкан", "изригване", "планина"],
        },
        #[cfg(feature = "bn")]
        crate::Annotation {
            lang: "bn",
